...
Hamiltonian LAOSTOMatrixBased::Hk(double kx, double ky) const
{
    return Hkin(kx, ky) + HZeeman() + HAtomicSO() + HRashba(kx, ky) - mu * Eigen::MatrixXcd::Identity(n_bands, n_bands);
}

Hamiltonian LAOSTOMatrixBased::HBdG(double kx, double ky) const
{
...
Hamiltonian LAOSTOMatrixBased::HBdG_discrete_ky_onsite(double kx, double y) const
{
...
Hamiltonian LAOSTOMatrixBased::HBdG_discrete_ky_hopping_p(double kx, double y) const
{
    double ek_xy = -tl;
    double ek_xz = -th;
    double ek_yz = -tl;
    ...
    Hamiltonian res(2 * n_bands, 2 * n_bands);
...
Hamiltonian LAOSTOMatrixBased::HBdG_discrete_ky_hopping_m(double kx, double y) const
{
    double ek_xy = -tl;
    double ek_xz = -th;
    double ek_yz = -tl;
...
Hamiltonian LAOSTOMatrixBased::HBdG_discrete_onsite(double x, double y) const
{
...
Hamiltonian LAOSTOMatrixBased::HBdG_discrete_hopping_xp(double x, double y) const
{
    double ek_xy = -tl;
...
Hamiltonian LAOSTOMatrixBased::HBdG_discrete_hopping_xm(double x, double y) const
{
    double ek_xy = -tl;
    double ek_xz = -tl; // tl for hopping_x, th for hopping_y
    double ek_yz = -th; // th for hopping_x, tl for hopping_y
...
Hamiltonian LAOSTOMatrixBased::HBdG_discrete_hopping_yp(double x, double y) const
{
    double ek_xy = -tl;
...
Hamiltonian LAOSTOMatrixBased::HBdG_discrete_hopping_ym(double x, double y) const
{
    double ek_xy = -tl;
    double ek_xz = -th; // tl for hopping_x, th for hopping_y
    double ek_yz = -tl; // th for hopping_x, tl for hopping_y
...
Hamiltonian LAOSTOMatrixBased::Hkin(double kx, double ky) const
{
...
Hamiltonian LAOSTOMatrixBased::HZeeman() const
{
...
Hamiltonian LAOSTOMatrixBased::HAtomicSO() const
{
    return delta_SO / 3.0 * HSO_mat;
}

Hamiltonian LAOSTOMatrixBased::HRashba(double kx, double ky) const
{
    Eigen::Matrix3cd rso;
