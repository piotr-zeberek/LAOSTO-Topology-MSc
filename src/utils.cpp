...
// // py::module pf = py::module::import("pfapack.pfaffian");
py::function cpf = pf.attr("pfaffian");

// Create a dedicated "module-like" namespace
py::dict pfapack;

// Define multiple Python functions as if they were inside a module
const char *pfapack_code = R"(
...
double pfaffian(const Eigen::MatrixXd &A)
{
    ...
    //     py::exec(pfapack_code, pfapack);
    //     PFAPACK_INITIALIZED = 1;
    // }
    // auto kwargs = py::dict("A"_a = A, "method"_a = "P");
